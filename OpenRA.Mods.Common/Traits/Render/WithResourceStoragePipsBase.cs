...
{
	public abstract class WithResourceStoragePipsDecorationInfoBase : WithDecorationBaseInfo
	{
		[FieldLoader.Require]
	...
	// TODO: Will WithDecorationBase<> support being used with a derived class?
	public abstract class WithResourceStoragePipsDecorationBase<InfoType> : WithDecorationBase<InfoType>
	where InfoType : WithResourceStoragePipsDecorationInfoBase
	{
		...
		protected WithResourceStoragePipsDecorationBase(Actor self, InfoType info)
			: base(self, info)
		{
		...
		protected override IEnumerable<IRenderable> RenderDecoration(Actor self, WorldRenderer wr, int2 screenPos)
		{
			...
			{
				pips.PlayRepeating(Amount * Info.PipCount > i * Capacity ? Info.FullSequence : Info.EmptySequence);
