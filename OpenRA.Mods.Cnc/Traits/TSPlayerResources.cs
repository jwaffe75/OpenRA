...
namespace OpenRA.Mods.Cnc.Traits
{
	...
	public class TSPlayerResourcesInfo : PlayerResourcesBaseInfo
	{
	...
	public class TSPlayerResources : PlayerResourcesBase
	{
		public readonly TSPlayerResourcesInfo Info;

		public TSPlayerResources(Actor self, TSPlayerResourcesInfo info)
		: base(self, info)
		{
			Info = info;
		}
